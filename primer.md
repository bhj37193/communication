...
P0-29 deploy artifacts (author-only half) closed.
...
task: check git status, re-ask about the key, do not invent scope.
...
- Prompt design LOCKED this session: static system per unit; per-turn context in
